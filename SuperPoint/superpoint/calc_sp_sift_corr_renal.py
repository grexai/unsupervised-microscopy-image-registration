...
if __name__ == '__main__':
    ...
    for method in ['nostyle','comir','unet_aligned','cyclegan_aligned','cut_aligned','pix2pix_aligned','cyclegan_unaligned','cut_unaligned']:
        ...
        if method == 'pix2pix_aligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_b18zHella40_63x_bestf/test_latest/images/*_fake_B.png' 
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_b18zHella40_63x_bestf/test_latest/images/'
            images = glob.glob(f"{p2p_path}*_fake_B.png")
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake_B","real_B")
        elif method == 'cyclegan_aligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/cycle_b18z40_63x_bestf_resize_mode_aligned/test_latest/images/*_fake.png'
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_b18zHella40_63x_bestf/test_latest/images/'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")
        elif method == 'comir':
            p2p_fake_images = './datasets//CoMIR/results/export_b18z40_63x/*R2.tif'
            p2p_path = './datasets//CoMIR/results/export_b18z40_63x'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")    
        elif method =='cut_aligned':
            p2p_fake_images = './datasets//contrastive-unpaired-translation/results/cut_b18z40_63x_aligned_resize_selected_mode_aligned/test_latest/images/fake_B/*.png'
            p2p_path = './datasets//contrastive-unpaired-translation/results/cut_b18z40_63x_aligned_resize_selected_mode_aligned/test_latest/images/real_B/'
            images = glob.glob(p2p_fake_images)
        elif method == 'unet_aligned':
            p2p_fake_images = '/storage01/grexai/dev/Unet-torch/test_config_Hella/*.png'
            p2p_path = '/storage01/grexai/datasets/imgreg/Image_registration/b18z40-63x/splitted_bestf/test/testB/'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{img2_file}/{fname}{ext}'
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")
        elif method == 'pix2pix_unaligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_b18zHella40_63x_bestf_unaligned/test_latest/images/*_fake_B.png' 
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_b18zHella40_63x_bestf_unaligned/test_latest/images/'
            images = glob.glob(f"{p2p_path}*_fake_B.png")
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake_B","real_B")
        elif method == 'cyclegan_unaligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/cycle_b18z40_63x_bestf_resize_unaligned/test_latest/images/*_fake.png'
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_b18zHella40_63x_bestf_unaligned/test_latest/images/'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")
        elif method =='cut_unaligned':
            p2p_fake_images = './datasets//contrastive-unpaired-translation/results/cut_b18z40_63x_unaligned_resize_selected/train_latest/images/fake_B/*.png'
            p2p_path = './datasets//contrastive-unpaired-translation/results/cut_b18z40_63x_unaligned_resize_selected/train_latest/images/real_B/'
            images = glob.glob(p2p_fake_images)    
        elif method == 'nostyle':
            p2p_fake_images  = '/storage01/grexai/datasets/imgreg/Image_registration/b18z40-63x/splitted_bestf/test/testA/*.png' 
            p2p_path ='/storage01/grexai/datasets/imgreg/Image_registration/b18z40-63x/splitted_bestf/test/testB/'
            images = glob.glob(p2p_fake_images)
        else:
            continue
        for image in tqdm(images):
            ...
            Hr, inliersr, _  = compute_superpoint(img2, img1, sess, input_img_tensor, output_prob_nms_tensor, output_desc_tensors)
            

            sift_Hr, sift_inliersr, _ = compute_sift(img2_orig, img1_orig)
            ...
            listH = Hr.tolist()
            with open(save_sp_json+base + '_' + base2 + '.json', 'w', encoding='utf-8') as f:
                json.dump(listH, f, indent=2)
            listSH = sift_Hr.tolist()
            with open(save_sift_json+base + '_' + base2 + '.json', 'w', encoding='utf-8') as f:
                json.dump(listSH, f, indent=2)
            listc = [c_shift[0], c_shift[1], c_angle, c_scale]
            with open(save_corr_json+base + '_' + base2 + '.json', 'w', encoding='utf-8') as f:
