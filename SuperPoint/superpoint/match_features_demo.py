...
"""
sp_v6 D:/datasets/Image_registration/230123NH-77995rqivU/trainA/p1_wA1_t1_m1010_c0_z1_l1_o0.png d:/datasets/Image_registration/230123NH-77995rqivU/registration/p1_wA1_t1_m1010_c1_z1_l1_o0.png
sp_v6 d:/dev/python/contrastive-unpaired-translation/checkpoints/tissue_test_train_all/train_latest/images/fake_B/p1_wA1_t1_m1010_c0_z1_l1_o0.png d:\datasets/Image_registration/230123NH-77995rqivU/registration/p1_wA1_t1_m1010_c1_z1_l1_o0.png
"""
...
def compute_rigid(matched_kp1, matched_kp2):
    ...
    print("Rigid transformation matrix:",H)
    return H, inliers
...
def preprocess_image2(img_file, img_size):
    img = cv2.imread(img_file, cv2.IMREAD_COLOR)
    img = img[:1024, :1024, :]
    img = cv2.resize(img, img_size)
    img_orig = img.copy()
...
if __name__ == '__main__':
    ...
    with tf.Session(graph=graph) as sess:
        ...
        img2, img2_orig = preprocess_image2(img2_file, img_size)
        ...
        H, inliers = compute_rigid(m_kp1, m_kp2)
        # cv2.drawKeypoints(img2_orig, kp2, img2_orig)
        # cv2.drawKeypoints(img1_orig, kp1, img1_orig)
        ...
        #cv2.imshow("SuperPoint matches.png", matched_img)
        cv2.imwrite("keypoints1.png", img1_orig)
        cv2.imwrite("keypoints2.png", img2_orig)
        ...
        cv2.waitKey(0)
        wp1 = cv2.warpAffine(img2_orig, H, (img1_orig.shape[0], img1_orig.shape[1]))
