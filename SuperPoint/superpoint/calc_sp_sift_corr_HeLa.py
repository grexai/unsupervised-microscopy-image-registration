...
if __name__ == '__main__':
    ...
    parser.add_argument('visualize', type=bool,nargs='?', default=False)
    ...
    for method in ['nostyle','comir','unet_aligned','cyclegan_aligned','cut_aligned','pix2pix_aligned','cyclegan_unaligned','cut_unaligned']:
        ...
        if method == 'pix2pix_aligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_hela63x_/test_latest/images/*_fake_B.png' 
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_hela63x_/test_latest/images/'
            images = glob.glob(f"{p2p_path}*_fake_B.png")
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake_B","real_B")
        elif method == 'cyclegan_aligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/cycle_hela63_resize_aligned_mode_aligned/test_latest/images/*_fake.png'
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_hela63x_/test_latest/images/'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")
        elif method == 'comir':
            p2p_fake_images = './datasets//CoMIR/results/export_hela63x_test/*R2.tif'
            p2p_path = './datasets//CoMIR/results/export_hela63x_test'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")    
        elif method =='cut_aligned':
            p2p_fake_images = './datasets//contrastive-unpaired-translation/results/cut_hela63_aligned_resize_mode_aligned/test_latest/images/fake_B/*.png'
            p2p_path = './datasets//contrastive-unpaired-translation/results/cut_hela63_aligned_resize_mode_aligned/test_latest/images/real_B/'
            images = glob.glob(p2p_fake_images)
        elif method == 'unet_aligned':
            p2p_fake_images = '/storage01/grexai/dev/Unet-torch/test_HeLa_maxdata5/*.png'
            p2p_path = '/storage01/grexai/datasets/imgreg/Image_registration/HeLa_60-63x/Aligned/test/testB/'
            images = glob.glob(p2p_fake_images)
            # fix_p = f'{img2_file}/{fname}{ext}'
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake","real_B")
        elif method == 'pix2pix_unaligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_hela63x_unaligned/test_latest/images/*_fake_B.png' 
            p2p_path = './datasets//pytorch-CycleGAN-and-pix2pix/results/p2p_hela63x_unaligned/test_latest/images/'
            images = glob.glob(f"{p2p_path}*_fake_B.png")
            # fix_p = f'{p2p_path}/{fname}{ext}'.replace("fake_B","real_B")
        elif method == 'cyclegan_unaligned':
            p2p_fake_images = './datasets//pytorch-CycleGAN-and-pix2pix/results/cycle_hela63_resize_unaligned/test_latest/images/*_fake.png'
            ...
            # p2p_fake_images = './datasets//contrastive-unpaired-translation/results/cut_hela63_unaligned_resize/train_latest/images/fake_B/*.png'
            p2p_fake_images = './datasets//contrastive-unpaired-translation/results/cut_hela63_aligned_resize_mode_aligned/test_latest/images/fake_B/*.png'
            p2p_path = './datasets//contrastive-unpaired-translation/results/cut_hela63_unaligned_resize/train_latest/images/real_B/'
            
            images = glob.glob(p2p_fake_images)    
        elif method == 'nostyle':
            p2p_fake_images  = '/storage01/grexai/datasets/imgreg/Image_registration/HeLa_60-63x/Aligned/test/testA/*.png' 
            p2p_path ='/storage01/grexai/datasets/imgreg/Image_registration/HeLa_60-63x/Aligned/test/testB/'
            images = glob.glob(p2p_fake_images)
        else:
            continue
        for image in tqdm(images):
            ...
            Hr, inliersr, matches  = compute_superpoint(img2, img1, sess, input_img_tensor, output_prob_nms_tensor, output_desc_tensors)
            ...
            if visualize:
                ...
                cv2.imwrite(save_sp_path+base+"matches_sp.png", matches)
